const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/NewServices1-DIjfd3Qf.js","assets/NewServices1-BGZ6TcA0.css","assets/About-BQGZlO_5.js","assets/About-B5tmuXhG.css","assets/OurServices-Dbut4r21.js","assets/OurServices-Be-SYaiP.css","assets/Testimonial-C_XSgMEc.js","assets/Testimonial-CcvXm_fL.css","assets/Pricing-Ba-ElY_V.js","assets/Pricing-SwlJ-I1o.css","assets/Contact-rGKlY2io.js","assets/Contact-Bsx0KrwL.css"])))=>i.map(i=>d[i]);
 ...
 *
 * @license MIT
 */var Zv="popstate";function t2(o={}){function n(r,s){let{pathname:u,search:f,hash:h}=r.location;return Qh("",{pathname:u,search:f,hash:h},s.state&&s.state.usr||null,s.state&&s.state.key||"default")}function i(r,s){return typeof s=="string"?s:Vs(s)}return n2(n,i,null,o)}function xe(o,n){if(o===!1||o===null||typeof o>"u")throw new Error(n)}function ir(o,n){if(!o){typeof console<"u"&&console.warn(n);try{throw new Error(n)}catch{}}}function e2(){return Math.random().toString(36).substring(2,10)}function Kv(o,n){return{usr:o.state,key:o.key,idx:n}}function Qh(o,n,i=null,r){return{pathname:typeof o=="string"?o:o.pathname,search:"",hash:"",...typeof n=="string"?Oo(n):n,state:i,key:n&&n.key||r||e2()}}function Vs({pathname:o="/",search:n="",hash:i=""}){return n&&n!=="?"&&(o+=n.charAt(0)==="?"?n:"?"+n),i&&i!=="#"&&(o+=i.charAt(0)==="#"?i:"#"+i),o}function Oo(o){let n={};if(o){let i=o.indexOf("#");i>=0&&(n.hash=o.substring(i),o=o.substring(0,i));let r=o.indexOf("?");r>=0&&(n.search=o.substring(r),o=o.substring(0,r)),o&&(n.pathname=o)}return n}function n2(o,n,i,r={}){let{window:s=document.defaultView,v5Compat:u=!1}=r,f=s.history,h="POP",m=null,p=g();p==null&&(p=0,f.replaceState({...f.state,idx:p},""));function g(){return(f.state||{idx:null}).idx}function _(){h="POP";let E=g(),w=E==null?null:E-p;p=E,m&&m({action:h,location:b.location,delta:w})}function x(E,w){h="PUSH";let k=Qh(b.location,E,w);p=g()+1;let D=Kv(k,p),R=b.createHref(k);try{f.pushState(D,"",R)}catch(C){if(C instanceof DOMException&&C.name==="DataCloneError")throw C;s.location.assign(R)}u&&m&&m({action:h,location:b.location,delta:1})}function y(E,w){h="REPLACE";let k=Qh(b.location,E,w);p=g();let D=Kv(k,p),R=b.createHref(k);f.replaceState(D,"",R),u&&m&&m({action:h,location:b.location,delta:0})}function O(E){return a2(E)}let b={get action(){return h},get location(){return o(s,f)},listen(E){if(m)throw new Error("A history only accepts one active listener");return s.addEventListener(Zv,_),m=E,()=>{s.removeEventListener(Zv,_),m=null}},createHref(E){return n(s,E)},createURL:O,encodeLocation(E){let w=O(E);return{pathname:w.pathname,search:w.search,hash:w.hash}},push:x,replace:y,go(E){return f.go(E)}};return b}function a2(o,n=!1){let i="http://localhost";typeof window<"u"&&(i=window.location.origin!=="null"?window.location.origin:window.location.href),xe(i,"No window.location.(origin|href) available to create URL");let r=typeof o=="string"?o:Vs(o);return r=r.replace(/ $/,"%20"),!n&&r.startsWith("//")&&(r=i+r),new URL(r,i)}function jb(o,n,i="/"){return r2(o,n,i,!1)}function r2(o,n,i,r){let s=typeof n=="string"?Oo(n):n,u=Lr(s.pathname||"/",i);if(u==null)return null;let f=Xb(o);i2(f);let h=null;for(let m=0;h==null&&m<f.length;++m){let p=g2(u);h=p2(f[m],p,r)}return h}function Xb(o,n=[],i=[],r=""){let s=(u,f,h)=>{let m={relativePath:h===void 0?u.path||"":h,caseSensitive:u.caseSensitive===!0,childrenIndex:f,route:u};m.relativePath.startsWith("/")&&(xe(m.relativePath.startsWith(r),`Absolute route path "${m.relativePath}" nested under path "${r}" is not valid. An absolute child route path must start with the combined path of all its parent routes.`),m.relativePath=m.relativePath.slice(r.length));let p=Nr([r,m.relativePath]),g=i.concat(m);u.children&&u.children.length>0&&(xe(u.index!==!0,`Index routes must not have child routes. Please remove all child routes from route path "${p}".`),Xb(u.children,n,g,p)),!(u.path==null&&!u.index)&&n.push({path:p,score:d2(p,u.index),routesMeta:g})};return o.forEach((u,f)=>{if(u.path===""||!u.path?.includes("?"))s(u,f);else for(let h of Gb(u.path))s(u,f,h)}),n}function Gb(o){let n=o.split("/");if(n.length===0)return[];let[i,...r]=n,s=i.endsWith("?"),u=i.replace(/\?$/,"");if(r.length===0)return s?[u,""]:[u];let f=Gb(r.join("/")),h=[];return h.push(...f.map(m=>m===""?u:[u,m].join("/"))),s&&h.push(...f),h.map(m=>o.startsWith("/")&&m===""?"/":m)}function i2(o){o.sort((n,i)=>n.score!==i.score?i.score-n.score:h2(n.routesMeta.map(r=>r.childrenIndex),i.routesMeta.map(r=>r.childrenIndex)))}var l2=/^:[\w-]+$/,o2=3,s2=2,u2=1,c2=10,f2=-2,Jv=o=>o==="*";function d2(o,n){let i=o.split("/"),r=i.length;return i.some(Jv)&&(r+=f2),n&&(r+=s2),i.filter(s=>!Jv(s)).reduce((s,u)=>s+(l2.test(u)?o2:u===""?u2:c2),r)}function h2(o,n){return o.length===n.length&&o.slice(0,-1).every((r,s)=>r===n[s])?o[o.length-1]-n[n.length-1]:0}function p2(o,n,i=!1){let{routesMeta:r}=o,s={},u="/",f=[];for(let h=0;h<r.length;++h){let m=r[h],p=h===r.length-1,g=u==="/"?n:n.slice(u.length)||"/",_=Kc({path:m.relativePath,caseSensitive:m.caseSensitive,end:p},g),x=m.route;if(!_&&p&&i&&!r[r.length-1].route.index&&(_=Kc({path:m.relativePath,caseSensitive:m.caseSensitive,end:!1},g)),!_)return null;Object.assign(s,_.params),f.push({params:s,pathname:Nr([u,_.pathname]),pathnameBase:_2(Nr([u,_.pathnameBase])),route:x}),_.pathnameBase!=="/"&&(u=Nr([u,_.pathnameBase]))}return f}function Kc(o,n){typeof o=="string"&&(o={path:o,caseSensitive:!1,end:!0});let[i,r]=m2(o.path,o.caseSensitive,o.end),s=n.match(i);if(!s)return null;let u=s[0],f=u.replace(/(.)\/+$/,"$1"),h=s.slice(1);return{params:r.reduce((p,{paramName:g,isOptional:_},x)=>{if(g==="*"){let O=h[x]||"";f=u.slice(0,u.length-O.length).replace(/(.)\/+$/,"$1")}const y=h[x];return _&&!y?p[g]=void 0:p[g]=(y||"").replace(/%2F/g,"/"),p},{}),pathname:u,pathnameBase:f,pattern:o}}function m2(o,n=!1,i=!0){ir(o==="*"||!o.endsWith("*")||o.endsWith("/*"),`Route path "${o}" will be treated as if it were "${o.replace(/\*$/,"/*")}" because the \`*\` character must always follow a \`/\` in the pattern. To get rid of this warning, please change the route path to "${o.replace(/\*$/,"/*")}".`);let r=[],s="^"+o.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(f,h,m)=>(r.push({paramName:h,isOptional:m!=null}),m?"/?([^\\/]+)?":"/([^\\/]+)"));return o.endsWith("*")?(r.push({paramName:"*"}),s+=o==="*"||o==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):i?s+="\\/*$":o!==""&&o!=="/"&&(s+="(?:(?=\\/|$))"),[new RegExp(s,n?void 0:"i"),r]}function g2(o){try{return o.split("/").map(n=>decodeURIComponent(n).replace(/\//g,"%2F")).join("/")}catch(n){return ir(!1,`The URL path "${o}" could not be decoded because it is a malformed URL segment. This is probably due to a bad percent encoding (${n}).`),o}}function Lr(o,n){if(n==="/")return o;if(!o.toLowerCase().startsWith(n.toLowerCase()))return null;let i=n.endsWith("/")?n.length-1:n.length,r=o.charAt(i);return r&&r!=="/"?null:o.slice(i)||"/"}function v2(o,n="/"){let{pathname:i,search:r="",hash:s=""}=typeof o=="string"?Oo(o):o;return{pathname:i?i.startsWith("/")?i:b2(i,n):n,search:x2(r),hash:T2(s)}}function b2(o,n){let i=n.replace(/\/+$/,"").split("/");return o.split("/").forEach(s=>{s===".."?i.length>1&&i.pop():s!=="."&&i.push(s)}),i.length>1?i.join("/"):"/"}function kh(o,n,i,r){return`Cannot include a '${o}' character in a manually specified \`to.${n}\` field [${JSON.stringify(r)}].  Please separate it out to the \`to.${i}\` field. Alternatively you may provide the full path as a string in <Link to="..."> and the router will parse it for you.`}function y2(o){return o.filter((n,i)=>i===0||n.route.path&&n.route.path.length>0)}function Vb(o){let n=y2(o);return n.map((i,r)=>r===n.length-1?i.pathname:i.pathnameBase)}function Qb(o,n,i,r=!1){let s;typeof o=="string"?s=Oo(o):(s={...o},xe(!s.pathname||!s.pathname.includes("?"),kh("?","pathname","search",s)),xe(!s.pathname||!s.pathname.includes("#"),kh("#","pathname","hash",s)),xe(!s.search||!s.search.includes("#"),kh("#","search","hash",s)));let u=o===""||s.pathname==="",f=u?"/":s.pathname,h;if(f==null)h=i;else{let _=n.length-1;if(!r&&f.startsWith("..")){let x=f.split("/");for(;x[0]==="..";)x.shift(),_-=1;s.pathname=x.join("/")}h=_>=0?n[_]:"/"}let m=v2(s,h),p=f&&f!=="/"&&f.endsWith("/"),g=(u||f===".")&&i.endsWith("/");return!m.pathname.endsWith("/")&&(p||g)&&(m.pathname+="/"),m}var Nr=o=>o.join("/").replace(/\/\/+/g,"/"),_2=o=>o.replace(/\/+$/,"").replace(/^\/*/,"/"),x2=o=>!o||o==="?"?"":o.startsWith("?")?o:"?"+o,T2=o=>!o||o==="#"?"":o.startsWith("#")?o:"#"+o;function S2(o){return o!=null&&typeof o.status=="number"&&typeof o.statusText=="string"&&typeof o.internal=="boolean"&&"data"in o}var Zb=["POST","PUT","PATCH","DELETE"];new Set(Zb);var O2=["GET",...Zb];new Set(O2);var Eo=j.createContext(null);Eo.displayName="DataRouter";var uf=j.createContext(null);uf.displayName="DataRouterState";j.createContext(!1);var Kb=j.createContext({isTransitioning:!1});Kb.displayName="ViewTransition";var E2=j.createContext(new Map);E2.displayName="Fetchers";var w2=j.createContext(null);w2.displayName="Await";var or=j.createContext(null);or.displayName="Navigation";var nu=j.createContext(null);nu.displayName="Location";var Yr=j.createContext({outlet:null,matches:[],isDataRoute:!1});Yr.displayName="Route";var E0=j.createContext(null);E0.displayName="RouteError";function A2(o,{relative:n}={}){xe(au(),"useHref() may be used only in the context of a <Router> component.");let{basename:i,navigator:r}=j.useContext(or),{hash:s,pathname:u,search:f}=ru(o,{relative:n}),h=u;return i!=="/"&&(h=u==="/"?i:Nr([i,u])),r.createHref({pathname:h,search:f,hash:s})}function au(){return j.useContext(nu)!=null}function gl(){return xe(au(),"useLocation() may be used only in the context of a <Router> component."),j.useContext(nu).location}var Jb="You should call navigate() in a React.useEffect(), not when your component is first rendered.";function $b(o){j.useContext(or).static||j.useLayoutEffect(o)}function w0(){let{isDataRoute:o}=j.useContext(Yr);return o?Y2():k2()}function k2(){xe(au(),"useNavigate() may be used only in the context of a <Router> component.");let o=j.useContext(Eo),{basename:n,navigator:i}=j.useContext(or),{matches:r}=j.useContext(Yr),{pathname:s}=gl(),u=JSON.stringify(Vb(r)),f=j.useRef(!1);return $b(()=>{f.current=!0}),j.useCallback((m,p={})=>{if(ir(f.current,Jb),!f.current)return;if(typeof m=="number"){i.go(m);return}let g=Qb(m,JSON.parse(u),s,p.relative==="path");o==null&&n!=="/"&&(g.pathname=g.pathname==="/"?n:Nr([n,g.pathname])),(p.replace?i.replace:i.push)(g,p.state,p)},[n,i,u,s,o])}j.createContext(null);function ru(o,{relative:n}={}){let{matches:i}=j.useContext(Yr),{pathname:r}=gl(),s=JSON.stringify(Vb(i));return j.useMemo(()=>Qb(o,JSON.parse(s),r,n==="path"),[o,s,r,n])}function D2(o,n){return Fb(o,n)}function Fb(o,n,i,r){xe(au(),"useRoutes() may be used only in the context of a <Router> component.");let{navigator:s}=j.useContext(or),{matches:u}=j.useContext(Yr),f=u[u.length-1],h=f?f.params:{},m=f?f.pathname:"/",p=f?f.pathnameBase:"/",g=f&&f.route;{let w=g&&g.path||"";Wb(m,!g||w.endsWith("*")||w.endsWith("*?"),`You rendered descendant <Routes> (or called \`useRoutes()\`) at "${m}" (under <Route path="${w}">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won't match anymore and therefore the child routes will never render.

Please change the parent <Route path="${w}"> to <Route path="${w==="/"?"*":`${w}/*`}">.`)}let _=gl(),x;if(n){let w=typeof n=="string"?Oo(n):n;xe(p==="/"||w.pathname?.startsWith(p),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${p}" but pathname "${w.pathname}" was given in the \`location\` prop.`),x=w}else x=_;let y=x.pathname||"/",O=y;if(p!=="/"){let w=p.replace(/^\//,"").split("/");O="/"+y.replace(/^\//,"").split("/").slice(w.length).join("/")}let b=jb(o,{pathname:O});ir(g||b!=null,`No routes matched location "${x.pathname}${x.search}${x.hash}" `),ir(b==null||b[b.length-1].route.element!==void 0||b[b.length-1].route.Component!==void 0||b[b.length-1].route.lazy!==void 0,`Matched leaf route at location "${x.pathname}${x.search}${x.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let E=N2(b&&b.map(w=>Object.assign({},w,{params:Object.assign({},h,w.params),pathname:Nr([p,s.encodeLocation?s.encodeLocation(w.pathname).pathname:w.pathname]),pathnameBase:w.pathnameBase==="/"?p:Nr([p,s.encodeLocation?s.encodeLocation(w.pathnameBase).pathname:w.pathnameBase])})),u,i,r);return n&&E?j.createElement(nu.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...x},navigationType:"POP"}},E):E}function M2(){let o=q2(),n=S2(o)?`${o.status} ${o.statusText}`:o instanceof Error?o.message:JSON.stringify(o),i=o instanceof Error?o.stack:null,r="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:r},u={padding:"2px 4px",backgroundColor:r},f=null;return console.error("Error handled by React Router default ErrorBoundary:",o),f=j.createElement(j.Fragment,null,j.createElement("p",null,"💿 Hey developer 👋"),j.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",j.createElement("code",{style:u},"ErrorBoundary")," or"," ",j.createElement("code",{style:u},"errorElement")," prop on your route.")),j.createElement(j.Fragment,null,j.createElement("h2",null,"Unexpected Application Error!"),j.createElement("h3",{style:{fontStyle:"italic"}},n),i?j.createElement("pre",{style:s},i):null,f)}var R2=j.createElement(M2,null),C2=class extends j.Component{constructor(o){super(o),this.state={location:o.location,revalidation:o.revalidation,error:o.error}}static getDerivedStateFromError(o){return{error:o}}static getDerivedStateFromProps(o,n){return n.location!==o.location||n.revalidation!=="idle"&&o.revalidation==="idle"?{error:o.error,location:o.location,revalidation:o.revalidation}:{error:o.error!==void 0?o.error:n.error,location:n.location,revalidation:o.revalidation||n.revalidation}}componentDidCatch(o,n){console.error("React Router caught the following error during render",o,n)}render(){return this.state.error!==void 0?j.createElement(Yr.Provider,{value:this.props.routeContext},j.createElement(E0.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function z2({routeContext:o,match:n,children:i}){let r=j.useContext(Eo);return r&&r.static&&r.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(r.staticContext._deepestRenderedBoundaryId=n.route.id),j.createElement(Yr.Provider,{value:o},i)}function N2(o,n=[],i=null,r=null){if(o==null){if(!i)return null;if(i.errors)o=i.matches;else if(n.length===0&&!i.initialized&&i.matches.length>0)o=i.matches;else return null}let s=o,u=i?.errors;if(u!=null){let m=s.findIndex(p=>p.route.id&&u?.[p.route.id]!==void 0);xe(m>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(u).join(",")}`),s=s.slice(0,Math.min(s.length,m+1))}let f=!1,h=-1;if(i)for(let m=0;m<s.length;m++){let p=s[m];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(h=m),p.route.id){let{loaderData:g,errors:_}=i,x=p.route.loader&&!g.hasOwnProperty(p.route.id)&&(!_||_[p.route.id]===void 0);if(p.route.lazy||x){f=!0,h>=0?s=s.slice(0,h+1):s=[s[0]];break}}}return s.reduceRight((m,p,g)=>{let _,x=!1,y=null,O=null;i&&(_=u&&p.route.id?u[p.route.id]:void 0,y=p.route.errorElement||R2,f&&(h<0&&g===0?(Wb("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),x=!0,O=null):h===g&&(x=!0,O=p.route.hydrateFallbackElement||null)));let b=n.concat(s.slice(0,g+1)),E=()=>{let w;return _?w=y:x?w=O:p.route.Component?w=j.createElement(p.route.Component,null):p.route.element?w=p.route.element:w=m,j.createElement(z2,{match:p,routeContext:{outlet:m,matches:b,isDataRoute:i!=null},children:w})};return i&&(p.route.ErrorBoundary||p.route.errorElement||g===0)?j.createElement(C2,{location:i.location,revalidation:i.revalidation,component:y,error:_,children:E(),routeContext:{outlet:null,matches:b,isDataRoute:!0}}):E()},null)}function A0(o){return`${o} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function U2(o){let n=j.useContext(Eo);return xe(n,A0(o)),n}function L2(o){let n=j.useContext(uf);return xe(n,A0(o)),n}function H2(o){let n=j.useContext(Yr);return xe(n,A0(o)),n}function k0(o){let n=H2(o),i=n.matches[n.matches.length-1];return xe(i.route.id,`${o} can only be used on routes that contain a unique "id"`),i.route.id}function B2(){return k0("useRouteId")}function q2(){let o=j.useContext(E0),n=L2("useRouteError"),i=k0("useRouteError");return o!==void 0?o:n.errors?.[i]}function Y2(){let{router:o}=U2("useNavigate"),n=k0("useNavigate"),i=j.useRef(!1);return $b(()=>{i.current=!0}),j.useCallback(async(s,u={})=>{ir(i.current,Jb),i.current&&(typeof s=="number"?o.navigate(s):await o.navigate(s,{fromRouteId:n,...u}))},[o,n])}var $v={};function Wb(o,n,i){!n&&!$v[o]&&($v[o]=!0,ir(!1,i))}j.memo(P2);function P2({routes:o,future:n,state:i}){return Fb(o,void 0,i,n)}function Wa(o){xe(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function j2({basename:o="/",children:n=null,location:i,navigationType:r="POP",navigator:s,static:u=!1}){xe(!au(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let f=o.replace(/^\/*/,"/"),h=j.useMemo(()=>({basename:f,navigator:s,static:u,future:{}}),[f,s,u]);typeof i=="string"&&(i=Oo(i));let{pathname:m="/",search:p="",hash:g="",state:_=null,key:x="default"}=i,y=j.useMemo(()=>{let O=Lr(m,f);return O==null?null:{location:{pathname:O,search:p,hash:g,state:_,key:x},navigationType:r}},[f,m,p,g,_,x,r]);return ir(y!=null,`<Router basename="${f}"> is not able to match the URL "${m}${p}${g}" because it does not start with the basename, so the <Router> won't render anything.`),y==null?null:j.createElement(or.Provider,{value:h},j.createElement(nu.Provider,{children:n,value:y}))}function X2({children:o,location:n}){return D2(Zh(o),n)}function Zh(o,n=[]){let i=[];return j.Children.forEach(o,(r,s)=>{if(!j.isValidElement(r))return;let u=[...n,s];if(r.type===j.Fragment){i.push.apply(i,Zh(r.props.children,u));return}xe(r.type===Wa,`[${typeof r.type=="string"?r.type:r.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),xe(!r.props.index||!r.props.children,"An index route cannot have child routes.");let f={id:r.props.id||u.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,hydrateFallbackElement:r.props.hydrateFallbackElement,HydrateFallback:r.props.HydrateFallback,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.hasErrorBoundary===!0||r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(f.children=Zh(r.props.children,u)),i.push(f)}),i}var Hc="get",Bc="application/x-www-form-urlencoded";function cf(o){return o!=null&&typeof o.tagName=="string"}function G2(o){return cf(o)&&o.tagName.toLowerCase()==="button"}function V2(o){return cf(o)&&o.tagName.toLowerCase()==="form"}function Q2(o){return cf(o)&&o.tagName.toLowerCase()==="input"}function Z2(o){return!!(o.metaKey||o.altKey||o.ctrlKey||o.shiftKey)}function K2(o,n){return o.button===0&&(!n||n==="_self")&&!Z2(o)}var gc=null;function J2(){if(gc===null)try{new FormData(document.createElement("form"),0),gc=!1}catch{gc=!0}return gc}var $2=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function Dh(o){return o!=null&&!$2.has(o)?(ir(!1,`"${o}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Bc}"`),null):o}function F2(o,n){let i,r,s,u,f;if(V2(o)){let h=o.getAttribute("action");r=h?Lr(h,n):null,i=o.getAttribute("method")||Hc,s=Dh(o.getAttribute("enctype"))||Bc,u=new FormData(o)}else if(G2(o)||Q2(o)&&(o.type==="submit"||o.type==="image")){let h=o.form;if(h==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let m=o.getAttribute("formaction")||h.getAttribute("action");if(r=m?Lr(m,n):null,i=o.getAttribute("formmethod")||h.getAttribute("method")||Hc,s=Dh(o.getAttribute("formenctype"))||Dh(h.getAttribute("enctype"))||Bc,u=new FormData(h,o),!J2()){let{name:p,type:g,value:_}=o;if(g==="image"){let x=p?`${p}.`:"";u.append(`${x}x`,"0"),u.append(`${x}y`,"0")}else p&&u.append(p,_)}}else{if(cf(o))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=Hc,r=null,s=Bc,f=o}return u&&s==="text/plain"&&(f=u,u=void 0),{action:r,method:i.toLowerCase(),encType:s,formData:u,body:f}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function D0(o,n){if(o===!1||o===null||typeof o>"u")throw new Error(n)}function W2(o,n,i){let r=typeof o=="string"?new URL(o,typeof window>"u"?"server://singlefetch/":window.location.origin):o;return r.pathname==="/"?r.pathname=`_root.${i}`:n&&Lr(r.pathname,n)==="/"?r.pathname=`${n.replace(/\/$/,"")}/_root.${i}`:r.pathname=`${r.pathname.replace(/\/$/,"")}.${i}`,r}async function I2(o,n){if(o.id in n)return n[o.id];try{let i=await import(o.module);return n[o.id]=i,i}catch(i){return console.error(`Error loading route module \`${o.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function t5(o){return o==null?!1:o.href==null?o.rel==="preload"&&typeof o.imageSrcSet=="string"&&typeof o.imageSizes=="string":typeof o.rel=="string"&&typeof o.href=="string"}async function e5(o,n,i){let r=await Promise.all(o.map(async s=>{let u=n.routes[s.route.id];if(u){let f=await I2(u,i);return f.links?f.links():[]}return[]}));return i5(r.flat(1).filter(t5).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function Fv(o,n,i,r,s,u){let f=(m,p)=>i[p]?m.route.id!==i[p].route.id:!0,h=(m,p)=>i[p].pathname!==m.pathname||i[p].route.path?.endsWith("*")&&i[p].params["*"]!==m.params["*"];return u==="assets"?n.filter((m,p)=>f(m,p)||h(m,p)):u==="data"?n.filter((m,p)=>{let g=r.routes[m.route.id];if(!g||!g.hasLoader)return!1;if(f(m,p)||h(m,p))return!0;if(m.route.shouldRevalidate){let _=m.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:i[0]?.params||{},nextUrl:new URL(o,window.origin),nextParams:m.params,defaultShouldRevalidate:!0});if(typeof _=="boolean")return _}return!0}):[]}function n5(o,n,{includeHydrateFallback:i}={}){return a5(o.map(r=>{let s=n.routes[r.route.id];if(!s)return[];let u=[s.module];return s.clientActionModule&&(u=u.concat(s.clientActionModule)),s.clientLoaderModule&&(u=u.concat(s.clientLoaderModule)),i&&s.hydrateFallbackModule&&(u=u.concat(s.hydrateFallbackModule)),s.imports&&(u=u.concat(s.imports)),u}).flat(1))}function a5(o){return[...new Set(o)]}function r5(o){let n={},i=Object.keys(o).sort();for(let r of i)n[r]=o[r];return n}function i5(o,n){let i=new Set;return new Set(n),o.reduce((r,s)=>{let u=JSON.stringify(r5(s));return i.has(u)||(i.add(u),r.push({key:u,link:s})),r},[])}function Ib(){let o=j.useContext(Eo);return D0(o,"You must render this element inside a <DataRouterContext.Provider> element"),o}function l5(){let o=j.useContext(uf);return D0(o,"You must render this element inside a <DataRouterStateContext.Provider> element"),o}var M0=j.createContext(void 0);M0.displayName="FrameworkContext";function ty(){let o=j.useContext(M0);return D0(o,"You must render this element inside a <HydratedRouter> element"),o}function o5(o,n){let i=j.useContext(M0),[r,s]=j.useState(!1),[u,f]=j.useState(!1),{onFocus:h,onBlur:m,onMouseEnter:p,onMouseLeave:g,onTouchStart:_}=n,x=j.useRef(null);j.useEffect(()=>{if(o==="render"&&f(!0),o==="viewport"){let b=w=>{w.forEach(k=>{f(k.isIntersecting)})},E=new IntersectionObserver(b,{threshold:.5});return x.current&&E.observe(x.current),()=>{E.disconnect()}}},[o]),j.useEffect(()=>{if(r){let b=setTimeout(()=>{f(!0)},100);return()=>{clearTimeout(b)}}},[r]);let y=()=>{s(!0)},O=()=>{s(!1),f(!1)};return i?o!=="intent"?[u,x,{}]:[u,x,{onFocus:_s(h,y),onBlur:_s(m,O),onMouseEnter:_s(p,y),onMouseLeave:_s(g,O),onTouchStart:_s(_,y)}]:[!1,x,{}]}function _s(o,n){return i=>{o&&o(i),i.defaultPrevented||n(i)}}function s5({page:o,...n}){let{router:i}=Ib(),r=j.useMemo(()=>jb(i.routes,o,i.basename),[i.routes,o,i.basename]);return r?j.createElement(c5,{page:o,matches:r,...n}):null}function u5(o){let{manifest:n,routeModules:i}=ty(),[r,s]=j.useState([]);return j.useEffect(()=>{let u=!1;return e5(o,n,i).then(f=>{u||s(f)}),()=>{u=!0}},[o,n,i]),r}function c5({page:o,matches:n,...i}){let r=gl(),{manifest:s,routeModules:u}=ty(),{basename:f}=Ib(),{loaderData:h,matches:m}=l5(),p=j.useMemo(()=>Fv(o,n,m,s,r,"data"),[o,n,m,s,r]),g=j.useMemo(()=>Fv(o,n,m,s,r,"assets"),[o,n,m,s,r]),_=j.useMemo(()=>{if(o===r.pathname+r.search+r.hash)return[];let O=new Set,b=!1;if(n.forEach(w=>{let k=s.routes[w.route.id];!k||!k.hasLoader||(!p.some(D=>D.route.id===w.route.id)&&w.route.id in h&&u[w.route.id]?.shouldRevalidate||k.hasClientLoader?b=!0:O.add(w.route.id))}),O.size===0)return[];let E=W2(o,f,"data");return b&&O.size>0&&E.searchParams.set("_routes",n.filter(w=>O.has(w.route.id)).map(w=>w.route.id).join(",")),[E.pathname+E.search]},[f,h,r,s,p,n,o,u]),x=j.useMemo(()=>n5(g,s),[g,s]),y=u5(g);return j.createElement(j.Fragment,null,_.map(O=>j.createElement("link",{key:O,rel:"prefetch",as:"fetch",href:O,...i})),x.map(O=>j.createElement("link",{key:O,rel:"modulepreload",href:O,...i})),y.map(({key:O,link:b})=>j.createElement("link",{key:O,...b})))}function f5(...o){return n=>{o.forEach(i=>{typeof i=="function"?i(n):i!=null&&(i.current=n)})}}var ey=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{ey&&(window.__reactRouterVersion="7.7.1")}catch{}function d5({basename:o,children:n,window:i}){let r=j.useRef();r.current==null&&(r.current=t2({window:i,v5Compat:!0}));let s=r.current,[u,f]=j.useState({action:s.action,location:s.location}),h=j.useCallback(m=>{j.startTransition(()=>f(m))},[f]);return j.useLayoutEffect(()=>s.listen(h),[s,h]),j.createElement(j2,{basename:o,children:n,location:u.location,navigationType:u.action,navigator:s})}var ny=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ii=j.forwardRef(function({onClick:n,discover:i="render",prefetch:r="none",relative:s,reloadDocument:u,replace:f,state:h,target:m,to:p,preventScrollReset:g,viewTransition:_,...x},y){let{basename:O}=j.useContext(or),b=typeof p=="string"&&ny.test(p),E,w=!1;if(typeof p=="string"&&b&&(E=p,ey))try{let Y=new URL(window.location.href),F=p.startsWith("//")?new URL(Y.protocol+p):new URL(p),it=Lr(F.pathname,O);F.origin===Y.origin&&it!=null?p=it+F.search+F.hash:w=!0}catch{ir(!1,`<Link to="${p}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let k=A2(p,{relative:s}),[D,R,C]=o5(r,x),X=g5(p,{replace:f,state:h,target:m,preventScrollReset:g,relative:s,viewTransition:_});function N(Y){n&&n(Y),Y.defaultPrevented||X(Y)}let G=j.createElement("a",{...x,...C,href:E||k,onClick:w||u?n:N,ref:f5(y,R),target:m,"data-discover":!b&&i==="render"?"true":void 0});return D&&!b?j.createElement(j.Fragment,null,G,j.createElement(s5,{page:k})):G});Ii.displayName="Link";var h5=j.forwardRef(function({"aria-current":n="page",caseSensitive:i=!1,className:r="",end:s=!1,style:u,to:f,viewTransition:h,children:m,...p},g){let _=ru(f,{relative:p.relative}),x=gl(),y=j.useContext(uf),{navigator:O,basename:b}=j.useContext(or),E=y!=null&&x5(_)&&h===!0,w=O.encodeLocation?O.encodeLocation(_).pathname:_.pathname,k=x.pathname,D=y&&y.navigation&&y.navigation.location?y.navigation.location.pathname:null;i||(k=k.toLowerCase(),D=D?D.toLowerCase():null,w=w.toLowerCase()),D&&b&&(D=Lr(D,b)||D);const R=w!=="/"&&w.endsWith("/")?w.length-1:w.length;let C=k===w||!s&&k.startsWith(w)&&k.charAt(R)==="/",X=D!=null&&(D===w||!s&&D.startsWith(w)&&D.charAt(w.length)==="/"),N={isActive:C,isPending:X,isTransitioning:E},G=C?n:void 0,Y;typeof r=="function"?Y=r(N):Y=[r,C?"active":null,X?"pending":null,E?"transitioning":null].filter(Boolean).join(" ");let F=typeof u=="function"?u(N):u;return j.createElement(Ii,{...p,"aria-current":G,className:Y,ref:g,style:F,to:f,viewTransition:h},typeof m=="function"?m(N):m)});h5.displayName="NavLink";var p5=j.forwardRef(({discover:o="render",fetcherKey:n,navigate:i,reloadDocument:r,replace:s,state:u,method:f=Hc,action:h,onSubmit:m,relative:p,preventScrollReset:g,viewTransition:_,...x},y)=>{let O=y5(),b=_5(h,{relative:p}),E=f.toLowerCase()==="get"?"get":"post",w=typeof h=="string"&&ny.test(h),k=D=>{if(m&&m(D),D.defaultPrevented)return;D.preventDefault();let R=D.nativeEvent.submitter,C=R?.getAttribute("formmethod")||f;O(R||D.currentTarget,{fetcherKey:n,method:C,navigate:i,replace:s,state:u,relative:p,preventScrollReset:g,viewTransition:_})};return j.createElement("form",{ref:y,method:E,action:b,onSubmit:r?m:k,...x,"data-discover":!w&&o==="render"?"true":void 0})});p5.displayName="Form";function m5(o){return`${o} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ay(o){let n=j.useContext(Eo);return xe(n,m5(o)),n}function g5(o,{target:n,replace:i,state:r,preventScrollReset:s,relative:u,viewTransition:f}={}){let h=w0(),m=gl(),p=ru(o,{relative:u});return j.useCallback(g=>{if(K2(g,n)){g.preventDefault();let _=i!==void 0?i:Vs(m)===Vs(p);h(o,{replace:_,state:r,preventScrollReset:s,relative:u,viewTransition:f})}},[m,h,p,i,r,n,o,s,u,f])}var v5=0,b5=()=>`__${String(++v5)}__`;function y5(){let{router:o}=ay("useSubmit"),{basename:n}=j.useContext(or),i=B2();return j.useCallback(async(r,s={})=>{let{action:u,method:f,encType:h,formData:m,body:p}=F2(r,n);if(s.navigate===!1){let g=s.fetcherKey||b5();await o.fetch(g,i,s.action||u,{preventScrollReset:s.preventScrollReset,formData:m,body:p,formMethod:s.method||f,formEncType:s.encType||h,flushSync:s.flushSync})}else await o.navigate(s.action||u,{preventScrollReset:s.preventScrollReset,formData:m,body:p,formMethod:s.method||f,formEncType:s.encType||h,replace:s.replace,state:s.state,fromRouteId:i,flushSync:s.flushSync,viewTransition:s.viewTransition})},[o,n,i])}function _5(o,{relative:n}={}){let{basename:i}=j.useContext(or),r=j.useContext(Yr);xe(r,"useFormAction must be used inside a RouteContext");let[s]=r.matches.slice(-1),u={...ru(o||".",{relative:n})},f=gl();if(o==null){u.search=f.search;let h=new URLSearchParams(u.search),m=h.getAll("index");if(m.some(g=>g==="")){h.delete("index"),m.filter(_=>_).forEach(_=>h.append("index",_));let g=h.toString();u.search=g?`?${g}`:""}}return(!o||o===".")&&s.route.index&&(u.search=u.search?u.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(u.pathname=u.pathname==="/"?i:Nr([i,u.pathname])),Vs(u)}function x5(o,{relative:n}={}){let i=j.useContext(Kb);xe(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:r}=ay("useViewTransitionState"),s=ru(o,{relative:n});if(!i.isTransitioning)return!1;let u=Lr(i.currentLocation.pathname,r)||i.currentLocation.pathname,f=Lr(i.nextLocation.pathname,r)||i.nextLocation.pathname;return Kc(s.pathname,f)!=null||Kc(s.pathname,u)!=null}const T5="modulepreload",S5=function(o){return"/codyatra/"+o},Wv={},Pr=function(n,i,r){let s=Promise.resolve();if(i&&i.length>0){let m=function(p){return Promise.all(p.map(g=>Promise.resolve(g).then(_=>({status:"fulfilled",value:_}),_=>({status:"rejected",reason:_}))))};document.getElementsByTagName("link");const f=document.querySelector("meta[property=csp-nonce]"),h=f?.nonce||f?.getAttribute("nonce");s=m(i.map(p=>{if(p=S5(p),p in Wv)return;Wv[p]=!0;const g=p.endsWith(".css"),_=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${p}"]${_}`))return;const x=document.createElement("link");if(x.rel=g?"stylesheet":T5,g||(x.as="script"),x.crossOrigin="",x.href=p,h&&x.setAttribute("nonce",h),document.head.appendChild(x),g)return new Promise((y,O)=>{x.addEventListener("load",y),x.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${p}`)))})}))}function u(f){const h=new Event("vite:preloadError",{cancelable:!0});if(h.payload=f,window.dispatchEvent(h),!h.defaultPrevented)throw f}return s.then(f=>{for(const h of f||[])h.status==="rejected"&&u(h.reason);return n().catch(u)})},O5="/codyatra/assets/intro-bNfiHPpZ.mp4";function Ze(o,n){n===void 0&&(n={});var i=n.insertAt;if(o&&typeof document<"u"){var r=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css",i==="top"&&r.firstChild?r.insertBefore(s,r.firstChild):r.appendChild(s),s.styleSheet?s.styleSheet.cssText=o:s.appendChild(document.createTextNode(o))}}Ze(`.react-loading-indicator-normalize,
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var on,jc,oa,xi,Ti,po,l1,Fi,Ls,o1,zr,Xa,s1,u1=function(){return on||typeof window<"u"&&(on=window.gsap)&&on.registerPlugin&&on},c1=1,uo=[],Nt=[],rr=[],Hs=Date.now,c0=function(n,i){return i},hS=function(){var n=Ls.core,i=n.bridge||{},r=n._scrollers,s=n._proxies;r.push.apply(r,Nt),s.push.apply(s,rr),Nt=r,rr=s,c0=function(f,h){return i[f](h)}},Ei=function(n,i){return~rr.indexOf(n)&&rr[rr.indexOf(n)+1][i]},Bs=function(n){return!!~o1.indexOf(n)},Sn=function(n,i,r,s,u){return n.addEventListener(i,r,{passive:s!==!1,capture:!!u})},Tn=function(n,i,r,s){return n.removeEventListener(i,r,!!s)},Ec="scrollLeft",wc="scrollTop",f0=function(){return zr&&zr.isPressed||Nt.cache++},af=function(n,i){var r=function s(u){if(u||u===0){c1&&(oa.history.scrollRestoration="manual");var f=zr&&zr.isPressed;u=s.v=Math.round(u)||(zr&&zr.iOS?1:0),n(u),s.cacheID=Nt.cache,f&&c0("ss",u)}else(i||Nt.cache!==s.cacheID||c0("ref"))&&(s.cacheID=Nt.cache,s.v=n());return s.v+s.offset};return r.offset=0,n&&r},kn={s:Ec,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:af(function(o){return arguments.length?oa.scrollTo(o,Qe.sc()):oa.pageXOffset||xi[Ec]||Ti[Ec]||po[Ec]||0})},Qe={s:wc,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:kn,sc:af(function(o){return arguments.length?oa.scrollTo(kn.sc(),o):oa.pageYOffset||xi[wc]||Ti[wc]||po[wc]||0})},Bn=function(n,i){return(i&&i._ctx&&i._ctx.selector||on.utils.toArray)(n)[0]||(typeof n=="string"&&on.config().nullTargetWarn!==!1?console.warn("Element not found:",n):null)},pS=function(n,i){for(var r=i.length;r--;)if(i[r]===n||i[r].contains(n))return!0;return!1},ki=function(n,i){var r=i.s,s=i.sc;Bs(n)&&(n=xi.scrollingElement||Ti);var u=Nt.indexOf(n),f=s===Qe.sc?1:2;!~u&&(u=Nt.push(n)-1),Nt[u+f]||Sn(n,"scroll",f0);var h=Nt[u+f],m=h||(Nt[u+f]=af(Ei(n,r),!0)||(Bs(n)?s:af(function(p){return arguments.length?n[r]=p:n[r]})));return m.target=n,h||(m.smooth=on.getProperty(n,"scrollBehavior")==="smooth"),m},d0=function(n,i,r){var s=n,u=n,f=Hs(),h=f,m=i||50,p=Math.max(500,m*3),g=function(O,b){var E=Hs();b||E-f>m?(u=s,s=O,h=f,f=E):r?s+=O:s=u+(O-u)/(E-h)*(f-h)},_=function(){u=s=r?0:s,h=f=0},x=function(O){var b=h,E=u,w=Hs();return(O||O===0)&&O!==s&&g(O),f===h||w-h>p?0:(s+(r?E:-E))/((r?w:f)-b)*1e3};return{update:g,reset:_,getVelocity:x}},Ss=function(n,i){return i&&!n._gsapAllow&&n.preventDefault(),n.changedTouches?n.changedTouches[0]:n},Tb=function(n){var i=Math.max.apply(Math,n),r=Math.min.apply(Math,n);return Math.abs(i)>=Math.abs(r)?i:r},f1=function(){Ls=on.core.globals().ScrollTrigger,Ls&&Ls.core&&hS()},d1=function(n){return on=n||u1(),!jc&&on&&typeof document<"u"&&document.body&&(oa=window,xi=document,Ti=xi.documentElement,po=xi.body,o1=[oa,xi,Ti,po],on.utils.clamp,s1=on.core.context||function(){},Fi="onpointerenter"in po?"pointer":"mouse",l1=Re.isTouch=oa.matchMedia&&oa.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in oa||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Xa=Re.eventTypes=("ontouchstart"in Ti?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in Ti?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return c1=0},500),f1(),jc=1),jc};kn.op=Qe;Nt.cache=0;var Re=function(){function o(i){this.init(i)}var n=o.prototype;return n.init=function(r){jc||d1(on)||console.warn("Please gsap.registerPlugin(Observer)"),Ls||f1();var s=r.tolerance,u=r.dragMinimum,f=r.type,h=r.target,m=r.lineHeight,p=r.debounce,g=r.preventDefault,_=r.onStop,x=r.onStopDelay,y=r.ignore,O=r.wheelSpeed,b=r.event,E=r.onDragStart,w=r.onDragEnd,k=r.onDrag,D=r.onPress,R=r.onRelease,C=r.onRight,X=r.onLeft,N=r.onUp,G=r.onDown,Y=r.onChangeX,F=r.onChangeY,it=r.onChange,W=r.onToggleX,_t=r.onToggleY,Tt=r.onHover,pt=r.onHoverEnd,L=r.onMove,Z=r.ignoreCheck,et=r.isNormalizer,mt=r.onGestureStart,T=r.onGestureEnd,Q=r.onWheel,at=r.onEnable,nt=r.onDisable,rt=r.onClick,bt=r.scrollSpeed,st=r.capture,Pt=r.allowClicks,wt=r.lockAxis,ce=r.onLockAxis;this.target=h=Bn(h)||Ti,this.vars=r,y&&(y=on.utils.toArray(y)),s=s||1e-9,u=u||0,O=O||1,bt=bt||1,f=f||"wheel,touch,pointer",p=p!==!1,m||(m=parseFloat(oa.getComputedStyle(po).lineHeight)||22);var ha,Ce,Ke,Ut,fe,un,vn,P=this,bn=0,pa=0,Na=r.passive||!g&&r.passive!==!1,ee=ki(h,kn),Ua=ki(h,Qe),La=ee(),sr=Ua(),ze=~f.indexOf("touch")&&!~f.indexOf("pointer")&&Xa[0]==="pointerdown",Mn=Bs(h),qt=h.ownerDocument||xi,Ne=[0,0,0],le=[0,0,0],Ha=0,Mi=function(){return Ha=Hs()},Te=function(gt,kt){return(P.event=gt)&&y&&pS(gt.target,y)||kt&&ze&&gt.pointerType!=="touch"||Z&&Z(gt,kt)},ur=function(){P._vx.reset(),P._vy.reset(),Ce.pause(),_&&_(P)},Rn=function(){var gt=P.deltaX=Tb(Ne),kt=P.deltaY=Tb(le),tt=Math.abs(gt)>=s,dt=Math.abs(kt)>=s;it&&(tt||dt)&&it(P,gt,kt,Ne,le),tt&&(C&&P.deltaX>0&&C(P),X&&P.deltaX<0&&X(P),Y&&Y(P),W&&P.deltaX<0!=bn<0&&W(P),bn=P.deltaX,Ne[0]=Ne[1]=Ne[2]=0),dt&&(G&&P.deltaY>0&&G(P),N&&P.deltaY<0&&N(P),F&&F(P),_t&&P.deltaY<0!=pa<0&&_t(P),pa=P.deltaY,le[0]=le[1]=le[2]=0),(Ut||Ke)&&(L&&L(P),Ke&&(E&&Ke===1&&E(P),k&&k(P),Ke=0),Ut=!1),un&&!(un=!1)&&ce&&ce(P),fe&&(Q(P),fe=!1),ha=0},Cn=function(gt,kt,tt){Ne[tt]+=gt,le[tt]+=kt,P._vx.update(gt),P._vy.update(kt),p?ha||(ha=requestAnimationFrame(Rn)):Rn()},Ba=function(gt,kt){wt&&!vn&&(P.axis=vn=Math.abs(gt)>Math.abs(kt)?"x":"y",un=!0),vn!=="y"&&(Ne[2]+=gt,P._vx.update(gt,!0)),vn!=="x"&&(le[2]+=kt,P._vy.update(kt,!0)),p?ha||(ha=requestAnimationFrame(Rn)):Rn()},zn=function(gt){if(!Te(gt,1)){gt=Ss(gt,g);var kt=gt.clientX,tt=gt.clientY,dt=kt-P.x,ft=tt-P.y,St=P.isDragging;P.x=kt,P.y=tt,(St||(dt||ft)&&(Math.abs(P.startX-kt)>=u||Math.abs(P.startY-tt)>=u))&&(Ke=St?2:1,St||(P.isDragging=!0),Ba(dt,ft))}},cr=P.onPress=function(Ot){Te(Ot,1)||Ot&&Ot.button||(P.axis=vn=null,Ce.pause(),P.isPressed=!0,Ot=Ss(Ot),bn=pa=0,P.startX=P.x=Ot.clientX,P.startY=P.y=Ot.clientY,P._vx.reset(),P._vy.reset(),Sn(et?h:qt,Xa[1],zn,Na,!0),P.deltaX=P.deltaY=0,D&&D(P))},At=P.onRelease=function(Ot){if(!Te(Ot,1)){Tn(et?h:qt,Xa[1],zn,!0);var gt=!isNaN(P.y-P.startY),kt=P.isDragging,tt=kt&&(Math.abs(P.x-P.startX)>3||Math.abs(P.y-P.startY)>3),dt=Ss(Ot);!tt&&gt&&(P._vx.reset(),P._vy.reset(),g&&Pt&&on.delayedCall(.08,function(){if(Hs()-Ha>300&&!Ot.defaultPrevented){if(Ot.target.click)Ot.target.click();else if(qt.createEvent){var ft=qt.createEvent("MouseEvents");ft.initMouseEvent("click",!0,!0,oa,1,dt.screenX,dt.screenY,dt.clientX,dt.clientY,!1,!1,!1,!1,0,null),Ot.target.dispatchEvent(ft)}}})),P.isDragging=P.isGesturing=P.isPressed=!1,_&&kt&&!et&&Ce.restart(!0),Ke&&Rn(),w&&kt&&w(P),R&&R(P,tt)}},Va=function(gt){return gt.touches&&gt.touches.length>1&&(P.isGesturing=!0)&&mt(gt,P.isDragging)},yn=function(){return(P.isGesturing=!1)||T(P)},en=function(gt){if(!Te(gt)){var kt=ee(),tt=Ua();Cn((kt-La)*bt,(tt-sr)*bt,1),La=kt,sr=tt,_&&Ce.restart(!0)}},Gn=function(gt){if(!Te(gt)){gt=Ss(gt,g),Q&&(fe=!0);var kt=(gt.deltaMode===1?m:gt.deltaMode===2?oa.innerHeight:1)*O;Cn(gt.deltaX*kt,gt.deltaY*kt,0),_&&!et&&Ce.restart(!0)}},Qa=function(gt){if(!Te(gt)){var kt=gt.clientX,tt=gt.clientY,dt=kt-P.x,ft=tt-P.y;P.x=kt,P.y=tt,Ut=!0,_&&Ce.restart(!0),(dt||ft)&&Ba(dt,ft)}},fr=function(gt){P.event=gt,Tt(P)},Vn=function(gt){P.event=gt,pt(P)},dr=function(gt){return Te(gt)||Ss(gt,g)&&rt(P)};Ce=P._dc=on.delayedCall(x||.25,ur).pause(),P.deltaX=P.deltaY=0,P._vx=d0(0,50,!0),P._vy=d0(0,50,!0),P.scrollX=ee,P.scrollY=Ua,P.isDragging=P.isGesturing=P.isPressed=!1,s1(this),P.enable=function(Ot){return P.isEnabled||(Sn(Mn?qt:h,"scroll",f0),f.indexOf("scroll")>=0&&Sn(Mn?qt:h,"scroll",en,Na,st),f.indexOf("wheel")>=0&&Sn(h,"wheel",Gn,Na,st),(f.indexOf("touch")>=0&&l1||f.indexOf("pointer")>=0)&&(Sn(h,Xa[0],cr,Na,st),Sn(qt,Xa[2],At),Sn(qt,Xa[3],At),Pt&&Sn(h,"click",Mi,!0,!0),rt&&Sn(h,"click",dr),mt&&Sn(qt,"gesturestart",Va),T&&Sn(qt,"gestureend",yn),Tt&&Sn(h,Fi+"enter",fr),pt&&Sn(h,Fi+"leave",Vn),L&&Sn(h,Fi+"move",Qa)),P.isEnabled=!0,P.isDragging=P.isGesturing=P.isPressed=Ut=Ke=!1,P._vx.reset(),P._vy.reset(),La=ee(),sr=Ua(),Ot&&Ot.type&&cr(Ot),at&&at(P)),P},P.disable=function(){P.isEnabled&&(uo.filter(function(Ot){return Ot!==P&&Bs(Ot.target)}).length||Tn(Mn?qt:h,"scroll",f0),P.isPressed&&(P._vx.reset(),P._vy.reset(),Tn(et?h:qt,Xa[1],zn,!0)),Tn(Mn?qt:h,"scroll",en,st),Tn(h,"wheel",Gn,st),Tn(h,Xa[0],cr,st),Tn(qt,Xa[2],At),Tn(qt,Xa[3],At),Tn(h,"click",Mi,!0),Tn(h,"click",dr),Tn(qt,"gesturestart",Va),Tn(qt,"gestureend",yn),Tn(h,Fi+"enter",fr),Tn(h,Fi+"leave",Vn),Tn(h,Fi+"move",Qa),P.isEnabled=P.isPressed=P.isDragging=!1,nt&&nt(P))},P.kill=P.revert=function(){P.disable();var Ot=uo.indexOf(P);Ot>=0&&uo.splice(Ot,1),zr===P&&(zr=0)},uo.push(P),et&&Bs(h)&&(zr=P),P.enable(b)},dS(o,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),o}();Re.version="3.13.0";Re.create=function(o){return new Re(o)};Re.register=d1;Re.getAll=function(){return uo.slice()};Re.getById=function(o){return uo.filter(function(n){return n.vars.id===o})[0]};u1()&&on.registerPlugin(Re);/*!
